...
mkdir -p /tmp/app/openresty/nginx/logs
touch /tmp/app/openresty/nginx/logs/error.log
mkdir -p /tmp/app/openresty/nginx/client_body_temp

mkdir -p $APP_ROOT/nginx/logs
touch $APP_ROOT/nginx/logs/error.log
touch $APP_ROOT/nginx/logs/access.log

cp -a $APP_ROOT/openresty/lualib /tmp/app/openresty/lualib/
